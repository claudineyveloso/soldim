...
func convertDBSalesOrdersRowToSalesOrder(dbSalesOrder db.GetSalesOrdersRow) *types.SalesOrder {
	return &types.SalesOrder{
		...
		Items: types.ItemsSalesOrders{
			ID:                 dbSalesOrder.ID,
			Codigo:             dbSalesOrder.Codigo,
			Unidade:            dbSalesOrder.Unidade,
			Quantidade:         dbSalesOrder.Quantidade,
			Desconto:           dbSalesOrder.Desconto,
			Valor:              dbSalesOrder.Valor,
			SalesOrderID:       dbSalesOrder.SalesOrderID,
			Aliquotaipi:        dbSalesOrder.Aliquotaipi,
			ProductID:          dbSalesOrder.ProductID,
			Descricao:          dbSalesOrder.Descricao,
			Descricaodetalhada: dbSalesOrder.Descricaodetalhada,
		},
	}
}

...
//		}
//
//		// Filtrar produtos por relevância
//		filteredProdutos := filterRelevantProducts(query, produtos)
//
//		// Log dos produtos coletados
//		log.Printf("Total de produtos coletados: %d", len(filteredProdutos))
//		for _, produto := range filteredProdutos {
//			log.Printf("Produto: %+v", produto)
//		}
//
//		return filteredProdutos, nil
//	}
//
// // Filtrar produtos com base na relevância
//
//	func filterRelevantProducts(query string, products []Produto) []Produto {
//		var relevantProducts []Produto
//		for _, product := range products {
//			score := utils.CalculateRelevanceScore(query, product.Description)
//			if score > 0 {
//				relevantProducts = append(relevantProducts, product)
//			}
//		}
